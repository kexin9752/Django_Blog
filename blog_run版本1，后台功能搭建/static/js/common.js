    ...
    function InitComment(page_id) {
        ...
        $.ajax({
            ...
            success: function (data) {
                var strHtml = '';
                for (var i in data) {
                    var com_txt = unescape(data[i].content);
                    com_txt = com_txt.replace(/\[Q([0-9]*)\]/g, "<img src='/images/face/mr/$1.gif'/>");
                    strHtml += '<li class="bg-color">' +
					'<div class="comment-ava"><a href="#" id="Comment-21" target="_blank" rel="nofollow" title="去他的的网站看看?">';
                    strHtml += '<img class="img-circle" src="/templates/myblog/images/Portrait/' + data[i].img_url + '.jpg"alt="他的导航" />';
                    ...
                    if (data[i].is_reply == 1) {
						...
						'<div class="admin-ava"><img src="/images/ava.gif" alt="管理员回复：" title="管理员回复：" class="img-circle"></div>' +
                        '<div class="re-info">' +
						'<span><img src="/images/ok.png"><a href="#" target="_blank" title="">管理员</a>	 <time>' + data[i].reply_time + '</time> 回复 <a href="#" title="">@' + data[i].user_name + '</a></span>' +
