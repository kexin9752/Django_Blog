...
!function (win, undefined) {
    ...
    var config = {
        ...
        right: -232,
        api: {
            friend: 'http://vip.rivermap.cn/Ajax/date/Handler1.ashx?type=Friends', //好友列表接口
            group: 'http://vip.rivermap.cn/Ajax/date/Handler1.ashx?type=Group', //群组列表接口 
            chatlog: 'http://vip.rivermap.cn/Ajax/date/Handler1.ashx?type=Chat', //聊天记录接口
            groups: 'http://vip.rivermap.cn/Ajax/date/Handler1.ashx?type=Members', //群组成员接口
            sendurl: '' //发送消息接口
        },
        user: { //当前用户信息
            name: '游客',
