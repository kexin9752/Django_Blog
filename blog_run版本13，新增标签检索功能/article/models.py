...
class Tag(models.Model):
    uid = models.UUIDField('uid编码',default=uuid.uuid4())
...
class Article(models.Model):
    ...
    img = models.ImageField('文章标题图片',null=True,blank=True,upload_to='%Y%m',default='201907/1.jpg')
    ...
    status = models.SmallIntegerField('文章审核',choices=constants.ARTICLE_STATUS_CHOICES,default=constants.ARTICLE_STATUS_WAIT)
