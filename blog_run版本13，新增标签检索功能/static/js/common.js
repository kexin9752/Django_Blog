...
// function ArticleModify(sendUrl, checkValue){
// 	alert('1111');
// 	//检查传输的值
// 	if (!checkValue) {
// 		dialog({title:'提示', content:'对不起，请选中您要修改的文章！', okValue:'确定', ok:function (){}}).showModal();
//         return false;
// 	}
// 	dialog({
//         title: '提示',
//         content: '您确定要修改此篇文章吗？文章修改后将返回待审核状态！',
//         okValue: '确定',
//         ok: function () {
//             $.ajax({
// 				type: "get",
...
function initCKPlayer(boxId, videoSrc, playerSrc){
    ...
    var video=[videoSrc];
    CKobject.embed(playerSrc,boxId,'ckplayer_a1','100%','100%',false,flashvars,video);
}    //'video_v1',
// 获取评论总数
