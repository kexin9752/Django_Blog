...
# @app.task
# def send_forget_password_email(to_email, username, new_password):
#     """发送激活邮件"""
#
#     # 组织邮件信息
#     subject = '欢迎回到KevIn博客'
...
#     sender = settings.DEFAULT_FROM_EMAIL
#     receiver = [to_email]
#     html_message = '<h1>%s, 欢迎您登录KevIn博客</h1>请点击下面链接重置您的账户密码<br/><a href="http://127.0.0.1:8000/accounts/user/email/verify/%s">http://127.0.0.1:8000/mail/reset/</a>'%(username, new_password, token)
#     time.sleep(5)
#     send_mail(subject, message, sender, receiver, html_message=html_message)
#     time.sleep(5)