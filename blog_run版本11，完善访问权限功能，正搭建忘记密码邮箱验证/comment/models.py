...
class CommentModel(models.Model):
    ...
    article = models.ForeignKey(Article,null=True,blank=True,verbose_name='文章',related_name='comment')
    note_id = models.IntegerField('留言id',null=True,blank=True)
    level_msg_id = models.IntegerField('随笔id',null=True,blank=True)
    photo_id = models.IntegerField('相册id',null=True,blank=True)
    mall_uid = models.CharField('商城uid',max_length=225,null=True,blank=True)
    qq = models.CharField('评论QQ',max_length=16,null=True,blank=True)
    tel = models.CharField('评论电话',max_length=16,null=True,blank=True)
